...
java -jar /path/to/find-unused.jar \
  ...
  --classpath "$HOME/Library/Caches/Coursier/v1/https/repo1.maven.org/maven2/org/scala-lang/scala-library/3.8.3/scala-library-3.8.3.jar" \
  --classpath ... \
...
As of Scala 3.8.3, the TASTy representation of some `inline` and macro-related methods does not include references to
...
As of Scala 3.8.3, the TASTy representation of calls to `transparent inline` methods is equivalent to the TASTy
